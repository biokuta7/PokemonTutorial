...
public class Evolution
{
    ...
    public PokemonData resultant;
    public int levelToEvolve;
    public ItemData itemToEvolve;
...
public class PokemonData : ScriptableObject {
    ...
    public Sprite sprite, backSprite, shinySprite, shinyBackSprite, footprintSprite;

    public PokemonTypeData type1, type2;
    public EggGroup eggGroup1, eggGroup2;
    public GrowthRate growthRate;
    public Habitat habitat;
    public float femaleRatio;

    public List<AbilityData> standardAbilities;
    public AbilityData hiddenAbility;

    public int baseHP, baseAttack, baseDefense, baseSpeed, baseSpecialAttack, baseSpecialDefense;
    ...
    public void Init()
    {
        ...
        standardAbilities = new List<AbilityData>();
        learnedMoves = new List<LearnedMove>();
        eggMoves = new List<MoveData>();
    }

    public MoveData[] GetBestMovesAtLevel(int level)
    {
        MoveData[] ret = new MoveData[4];
    ...
    public static float String2GenderRate(string genderRate)
    {
        switch (genderRate)
        {
            case "AlwaysMale":
    ...
    private static int[] XPTableMedium = new int[]
    {
    ...
    private static int[] XPTableParabolic = new int[]
    {
