...
public class DataGenerator : MonoBehaviour
{
    ...
    public PokemonData[] GeneratePokemon()
    {
        ...
        for (int i = 1; i <= NUMBER_OF_POKEMON; i++)
        {
            ...
            pokemonData.sprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Pokemon/" + paddedindexStr + ".png", typeof(Sprite));
            pokemonData.backSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Pokemon/" + paddedindexStr + "b.png", typeof(Sprite));
            pokemonData.shinySprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Pokemon/" + paddedindexStr + "s.png", typeof(Sprite));
            pokemonData.shinyBackSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Pokemon/" + paddedindexStr + "sb.png", typeof(Sprite));

            pokemonData.footprintSprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Footprints/footprint" + paddedindexStr + ".png", typeof(Sprite));
    ...
    public ItemData[] GenerateItems()
    {
        ...
        for (int i = 0; i < NUMBER_OF_ITEMS; i++)
        {
            ...
            item.sprite = (Sprite)AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Icons/item" + paddedindexStr + ".png", typeof(Sprite));
